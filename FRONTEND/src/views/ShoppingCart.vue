                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Bank Transfer <span>Bank Mandiri</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>1320022890280</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Wahyu Safrizal</span></li>
                                </ul>
                                <!-- <router-link to="/success"> -->
                               
                                 <div v-if="user">
                                    <a @click="checkout(),removeKeranjang(keranjangUser.index)" href="#" class="proceed-btn">BAYAR</a> 
                                </div>
                                <div v-else>
