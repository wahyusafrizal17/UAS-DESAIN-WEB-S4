            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        <i class=" fa fa-envelope"></i> wahyusafrizal174@gmail.com
                    </div>
                    <div class="phone-service">
                        <i class=" fa fa-phone"></i> 081318960576
                    </div>
                </div>
                  <div class="ht-right">
            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="./index.html">
                               <router-link to="/"><b><span style="color:#1c7664">Wayyy</span>Store</b></router-link>
                            </a>
                        </div>
                    </div>
